...
import scss from './WebDevelopmentFormScreen.module.scss';
import { useState } from 'react';
import clsx from 'clsx';

export default function WebDevelopmentFormScreen() {
  ...
  return (
    <div className={scss.formForDownload}>
      <div className={scss.container}>
        <h2>Замовити Веб-розробку</h2>
        <p>Замовляй розробку та отримай Результат від 10 днів</p>
