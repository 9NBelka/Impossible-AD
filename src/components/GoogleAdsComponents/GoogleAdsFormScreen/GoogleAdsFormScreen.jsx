...
import scss from './GoogleAdsFormScreen.module.scss';
import { useState } from 'react';
import clsx from 'clsx';

export default function GoogleAdsFormScreen() {
  ...
  return (
    <div className={scss.formForDownload}>
      <div className={scss.container}>
        <h2>Замовити Google Ads</h2>
        <p>Замовляй налаштування кампанії та отримай швидкий Результат </p>
