      ...
      <div className={scss.container}>
        <div className={scss.contentFlexRow}>
          <div className={scss.content}>
            <h1 className={scss.title}>Хочете отримувати більше клієнтів з Google?</h1>
            <p className={scss.subtitle}>Залиште заявку — ми підберемо рішення під ваш бізнес.</p>
          </div>
          <ContactForm
            name={name}
            setName={setName}
