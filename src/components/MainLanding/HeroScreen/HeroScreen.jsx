      ...
      <div className={scss.container}>
        <div className={scss.heroContent}>
          ...
          <p className={scss.heroSubtitle}>
            Профессиональные рекламные решения для социальных сетей, веб-сайтов и поисковых систем.
            Повысьте узнаваемость вашего бренда с помощью наших комплексных услуг цифрового
            маркетинга.
          </p>
